...
## 2nd version
def custom_cma_es2(function, x0, sigma, population_size, max_iter=1000, seed=None, output_file=None, iter_threshold=1, **kwargs):
    if seed is not None:
        np.random.seed(seed)
...
## 2nd version
def custom_cma_es_ext2(function, x0, sigma, population_size, max_iter=1000, seed=None, extinction_threshold=10,
                      extinction_rate_worst=0.4, extinction_rate_best=0.1, output_file=None, iter_threshold=1, **kwargs):
    if seed is not None:
        np.random.seed(seed)
